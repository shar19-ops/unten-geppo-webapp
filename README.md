...
- リポジトリ: https://github.com/shar19-ops/unten-geppo-webapp (public)
- 公開URL(GitHub Pages): https://shar19-ops.github.io/unten-geppo-webapp/
...
- 事業所名は社有車リストの車両マスタ(`officeName`)から転記表示するだけの読み取り専用。私有車は転記元が無いため空欄になる。
